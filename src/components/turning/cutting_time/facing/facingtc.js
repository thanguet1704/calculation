...
import N from '../../../../public/img/turning/cutting_time/facing/tc/t_npass.png';
    ...
    return (
        <form id="tab-fa">
            <div style={{ display: 'flex', flexDirection: 'column'}}>
                <h3><b>[Facing]<br/>&emsp;Cutting Time T<sub>c</sub> (Reference : n) [sec]</b></h3>
                <div style={divInputStyle}>
                    ...
                    <InputCommon src={N} placeholder="Number of Pass" setValue={setNPass}/>
                </div>
